...
distance et font totalement abstraction du graphe.
\section{Algorithmes}
...
le pire cas, on a pas un coût exponentiel. En tout cas, lorsque nous avons fait tourné L'algorithme, nous avons eu un
coût exponentiel (voir figure \label{fig:opt}). Sans doute sommes-nous tombés dans le pire cas.
  \begin{figure}[ht]
\begin{center}
